...
nohup /usr/bin/time -v Rscript --vanilla ./fastbaps_manuscript/run_ward_baps_partition_optbapsprior.R $FILE > "${FILE}_fastbaps_ward_partition_optbaps_prior.log" 2>&1 &
