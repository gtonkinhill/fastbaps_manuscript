nohup /usr/bin/time -v Rscript --vanilla ./fastbaps_manuscript/HIV_run_fastbaps_optbapsprior.R > ./data/HIV_run_fastbaps_optbapsprior.log 2>&1 &

nohup /usr/bin/time -v Rscript --vanilla ./fastbaps_manuscript/HIV_run_fastbaps_symmetric.R > ./data/HIV_run_fastbaps_symmetric.log 2>&1 &
