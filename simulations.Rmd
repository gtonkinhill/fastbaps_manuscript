...
calc_cluster_structure <- function(sparse.data, prefix, directory){
  ...
  run_structure_adapt(path_to_structure = "~/software/structure_v2.3.4/structure",
              ...
              n_K =  5, n_replicates = 1, n_loci = nrow(sparse.data$snp.matrix),
...
write.table(results.and.params.df, file="./simulations/simulation_results_island.csv",
...
write.table(results.and.params.nostruct.df, file="./simulations/simulation_results_island_no_structure.csv",
            row.names = FALSE, col.names = TRUE, quote=FALSE, sep=",")
```
